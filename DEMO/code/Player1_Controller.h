/**
* @file Player1_Controller.h
* @brief Controlador del jugador 1, tambíen hijo de Update_Component
...
class Player1_Controller : public Update_Component
{
	/// <summary>
...
public:
	...
	/// </summary>
	Player_Listener player1_up_listener;
	/// <summary>
	/// Listener para las acciones de descenso
	/// </summary>
	Player_Listener player1_down_listener;
	...
	void update(float t) override
	{
		...
		if (player1_up_listener.received)
		{		
			get_owner()->get_transform()->set_position({ position.x, position.y + 50.f * t, position.z });
			player1_up_listener.received = false;
		}

		if (player1_down_listener.received)
		{
			get_owner()->get_transform()->set_position({ position.x, position.y - 50.f * t, position.z });
			player1_down_listener.received = false;
		}
	}
};